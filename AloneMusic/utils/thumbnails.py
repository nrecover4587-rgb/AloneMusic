...
async def gen_thumb(videoid: str):
    ...
    try:
        ...
        draw.text((brand_x + shadow_offset, brand_y + shadow_offset), 
                 "ALONE", fill=(0, 0, 0, 150), font=brand_font)
        draw.text((brand_x, brand_y), "ALONE", fill=(255, 255, 255, 255), font=brand_font)
        
        brand_bbox = draw.textbbox((brand_x, brand_y), "ALONE", font=brand_font)
